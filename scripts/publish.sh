...
echo ""
echo "Next steps:"
echo "1. Check VS Code Marketplace: https://marketplace.visualstudio.com/items?itemName=cardor.commitlint-sage"
echo "2. Monitor extension page for visibility"
echo "3. Check GitHub releases: https://github.com/enmanuelmag/commitlint-sage/releases"
